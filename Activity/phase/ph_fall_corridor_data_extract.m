mat_files = dir(fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/corridor2_2/phase/*.mat'));
...
load(['C:\Users\R00119847\Documents\MATLAB\csi_tool_matlab\Activity\data\fall_detection\corridor2_2\phase\' mat_files(i).name])
