...
mat_files = dir(fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/kitchen2/phase/*.mat'));
% ph_empty_ant1 = load('C:\Users\R00119847\Documents\MATLAB\csi_tool_matlab\Activity\data\fall_detection\corridor1\phase\ph_empty_corridor11.mat')
...
load([fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/kitchen2/phase\') mat_files(i).name])
