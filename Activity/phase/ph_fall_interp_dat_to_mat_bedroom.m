...
TX_ant = 1;
corridor_files = dir(fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/bedrooms2/phase/*.dat'));

for i = 1:length(corridor_files)
file_name = corridor_files(i).name;
data_file = ['/Activity/data/fall_detection/bedrooms2/phase/' file_name];  
...
save(['C:\Users\R00119847\Documents\MATLAB\csi_tool_matlab\Activity\data\fall_detection\bedrooms2\phase\' name_phant12 ], 'phant12')
