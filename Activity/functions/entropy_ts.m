function [estimate,nbias,sigma,descriptor]=entropy_ts(x,descriptor,approach,base)
...
if nargin==1
  [h,descriptor]=histcounts(x);
end;

if nargin>=2
  [h,descriptor]=histcounts(x,descriptor);
end;
