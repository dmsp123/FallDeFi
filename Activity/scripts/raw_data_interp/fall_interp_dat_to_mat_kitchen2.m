...
data_file = ['/Activity/data/fall_detection/kitchen2/' file_name];  
...
save([fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/kitchen2/') name_ant1 ], 'ant1')
save([fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/kitchen2/') name_ant2 ], 'ant2')
save([fullfile(pwd,'csi_tool_matlab/Activity/data/fall_detection/kitchen2/') name_ant3 ], 'ant3')
end
%