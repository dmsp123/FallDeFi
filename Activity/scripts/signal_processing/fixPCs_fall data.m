...
%         
    sample_size =1000;
    dnPCA_netcell_array  = NET.createArray('System.Double[][]',length(fall_cell_array));
    eigs_netcell_array  = NET.createArray('System.Double[][]',length(fall_cell_array));
...
%         end
        eigs_netcell_array(i)  = eigenvalue;
        dnPCA_netcell_array(i) = PCs;%PCs;
    end  
    dnPCA_cell_array = cell(dnPCA_netcell_array);
    eigs_cell_array  = cell(eigs_netcell_array);
    
%     test1 = dnPCA_cell_array{32};     
%     figure;hold on
